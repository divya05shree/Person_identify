...
class FaceRecognitionApp:
    def __init__(self, root):
        ...
        self.process_every_n_frames = 5  # Process every 5th frame (increased from 3)
        self.frame_count = 0
        self.detection_size = (256, 192)  # Even smaller size for detection
        ...
        self.last_attendance_time = defaultdict(int)
        self.attendance_interval = 60  # 60 seconds between attendance records
        ...
        # Start update display loop (separate from recognition)
        threading.Thread(target=self.update_display_loop, daemon=True).start()
    ...
    def create_widgets(self):
        ...
        # FPS display
        self.fps_label = tk.Label(status_frame, text="FPS: --", bg="#e0e0e0")
    ...
    def capture_frames(self):
        ...
        while self.is_recognizing:
            ...
            # Add frame to queue, skip if queue is full (non-blocking)
            try:
    ...
    def update_display_loop(self):
        """Thread to update the display - separate from processing"""
    ...
    def update_image_display(self, frame):
        """Update the image display with the given frame"""
